...
const
  ...
  , DATA_WINDOWS = {
        'screensplash': {
          ...
          , x:              baseXY.baseX + ((baseXY.baseW - 550) / 2)
          , y:              baseXY.baseY + 300
...
class Window {
  ...
  **/
  ...
  /**
  * @return l'instance Window de la fenêtre des projets
  **/
  static get projets () {
    if ( undefined == this._projets )
    {
      this._projets = new Window('projets')
    }
