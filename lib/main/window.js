...
const
  ...
  , DATA_WINDOWS = {
          /**
          * Le screen-splash qui s'ouvre pendant que l'application
          * se charge.
          **/
          'screensplash': {
            name:           'screensplash'
        ...
        /**
        * La fenêtre qui permet de choisir un projet ou d'en créer un
        * nouveau.
        **/
      , 'projets': {
            name:             'projets'
        ...
        /**
        * La fenêtre qui affiche l'aide du programme.
        **/
      , 'aide': {
            name:             'aide'
          , width:            900
        ...
        /**
        * Fenêtre principale d'un projet en particulier (le projet courant) 
        **/
      , 'projet':{
            name:             'projet'
          , width:            1500
