...
class Constantes {
  ...
  static get STORE_MODULE_PATH ()
  {
    if(undefined===this._store_module_path){this._store_module_path=path.join(this.LIB_UTILS_FOLDER,'store.js')}
    return this._store_module_path
  }
  ...
  static get PTESTS_FOLDER () {
    if (undefined===this._ptests_folder){this._ptests_folder=path.join(this.APP_PATH,'tests','ptests')}
    return this._ptests_folder
  }
