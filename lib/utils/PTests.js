  ...
  actualTagContainsExpect ()
  {
    ...
    try
    {
      ...
      if ( exp.tag && exp.tag != '*' )
      {
        ...
        let capTag = `&lt; ${exp.tag.toUpperCase()} &gt;`
      ...
      log('Nombre d’éléments dans realElementList au départ:',realElementList.length)
      ...
      if ( exp.children )
      {
        ...
        // }
        nombre_founds = realElementList.length
        // log('Nombre de balises restantes après le test children :',nombre_founds)
