  ...
  *** --------------------------------------------------------------------- */
  ...
  run ()
  {
    ...
    catch(erreur)
    {
      ...
      // log('Erreur', erreur.constructor.name)
      // log(erreur.message)
    }
  }

  get hasBeforeEach () { return 'function' === typeof this.file.beforeEach }
  get hasAfterEach  () { return 'function' === typeof this.file.afterEach }
  runBeforeEach () { this.file.beforeEach.call(this)  }
  runAfterEach  () { this.file.afterEach.call(this)   }
