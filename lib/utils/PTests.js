...
class Writer
{
  ...
  builtMessage (message, type)
  {
    let child = document.createElement('div')
    child.className = this.classNameFor(type)
...
{clearInterval(timer)
  ...
  **/
  ...
  // On fait un writer pour écrire les résultats
